...
namespace Game
{
    ...
    public class PlayerInteractor : IPlayerInteractor, IAwakable, IUpdatable, IDisposable
    {
        ...
        public PlayerInteractor(IInput input, IGameLoop gameLoop,
        ...
        {
            _input.OnClickAction += (x) => Interact();
        ...
        private void CheckInteraction()
        {
            ...
            _currentInteractable = _callback.Interactable;
            
            OnPoint?.Invoke(_currentInteractable);
        }
