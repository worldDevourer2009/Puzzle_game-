...
namespace Game
{
    public interface IPlayerCore
    {
        ...
        void Initialize(Rigidbody rb, Cam cam, float speed, float jumpForce);
    ...
    public class PlayerCore : IPlayerCore
    {
        ...
        public void Initialize(Rigidbody rb, Cam cam, float speed, float jumpForce)
        {
            _rb = rb;
            _cam = cam;
            _speed = speed;
        ...
        public void Move(Vector3 direction, bool isRunning = false)
        {
            ...
            _moveable.Move(_rb.gameObject, _speed, moveDir);
